      ...
      <ion-content>
        ...
        <div class="about-header">
          ...
          <div
            ...
            style={{ opacity: this.location === "madison" ? "1" : null }}
          ></div>
          <div
            class="about-image austin"
            style={{ opacity: this.location === "austin" ? "1" : null }}
          ></div>
          <div
            class="about-image chicago"
            style={{ opacity: this.location === "chicago" ? "1" : null }}
          ></div>
          <div
            class="about-image seattle"
            style={{ opacity: this.location === "seattle" ? "1" : null }}
          ></div>
        </div>
        ...
        <div class="about-info">
          ...
          <p class="ion-padding-start ion-padding-end">
            ...
            {this.displayDate(this.conferenceDate, "mediumDate")} featuring
            talks from the Ionic team. It is focused on Ionic applications being
            built with Ionic Framework. This includes migrating apps to the
            latest version of the framework, Angular concepts, Webpack, Sass,
            and many other technologies used in Ionic 2. Tickets are completely
            sold out, and we’re expecting more than 1000 developers – making
            this the largest Ionic conference ever!
          </p>
          ...
          <ion-list lines="none">
            <ion-item>
              ...
              <ion-select
                ...
                onIonChange={(ev) => this.selectChanged(ev)}
              >
